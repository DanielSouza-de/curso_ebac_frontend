...
var timeDeFutebolDeSp = ['santos', 'palmeiras', 'bragantino', 'são paulo'];
var timeDeFutebolDoRio = ['vasco', 'botafogo', 'flamengo', 'fluminense'];

// const timesDeFutebol = timeDeFutebolDeSp.concat(timeDeFutebolDoRio);
var timesDeFutebol = [].concat(timeDeFutebolDeSp, timeDeFutebolDoRio);

// timeDeFutebolDeSp.concat(timeDeFutebolDoRio)
...
var _timesDeFutebol = _toArray(timesDeFutebol),
  ...
  outrosTimes = _arrayLikeToArray(_timesDeFutebol).slice(3);
console.log(item1);
console.log(item2);
console.log(item3);
